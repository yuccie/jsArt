...
function bubleSort(arr) {
  ...
  for(let i = 0; i < arrLen - 1; i++){
    let flag = false; //加标志位，如果一轮循环内没有一次交换数据，说明已排好序
...
因此如果想获取数据更新后的dom，只需要触发一个微任务,当微任务执行完就会开始更新dom。。。但微任务又有好几种或者没有(只能退而求其次改为红任务)
...
vue的diff算法来源于`snabbdom`，复杂度为O(0)，这点和react一样。diff的过程就是调用patch函数，就像打补丁一样修改真实的dom
...
=======
>>>>>>> 075349da5a281ab99c83b53ae8ed1c1f7f637608
>>>>>>> 8fb86ed31e0165150ec0f9573e55cddf5b756919
